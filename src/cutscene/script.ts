...
export const COLD_OPEN: Cutscene = {
  next: 'newgame',
  steps: [
    { kind: 'bg', image: 'ui/cutscene/co_waking.png', dark: 0.12 },
    ...
    { kind: 'bg', image: 'ui/cutscene/co_under.png', dark: 0.08 },
    { kind: 'line', speaker: '', text: 'Then the old world broke, and we went under. Hidden colonies — the Downtowns. Generations of low ceilings.' },
    { kind: 'bg', image: 'ui/cutscene/co_surface.png', dark: 0.06 },
    ...
    { kind: 'bg', image: 'ui/cutscene/co_static.png', dark: 0.18 },
    ...
    { kind: 'bg', image: 'ui/cutscene/co_under.png', dark: 0.1 },
    { kind: 'line', speaker: '', text: 'Tonight — Ohmstead, sublevel three — a kid is about to do something stupid.' },
  ],
};
...
export function grounded(preset: 'SAL' | 'WREN'): Cutscene {
  ...
  return {
    ...
    nextData: { preset },
    steps: [
      { kind: 'bg', image: 'ui/cutscene/garage.png', dark: 0.05 },
